       ...
       # print("Vibration analog value: ", reading)
        ...
        if pre_reading - reading > 300:
            if abs(pre_x[0] - x_acc) > 200:
                send_api('accident/workerAccident', 'POST', "Falling Accident Occurred.")
                print("Vibration: ", reading)
                print("Falling Accideent Occurred.")
            else:
                send_api('accident/workerAccident', 'POST', "Collision Accident Occurred.")
                print("Vibration: ", reading)
                print("Collsion Accident Occurred.")
